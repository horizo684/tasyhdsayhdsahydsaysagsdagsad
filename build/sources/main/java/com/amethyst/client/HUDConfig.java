...
public class HUDConfig {
    ...
    private static int soupCounterX = 5;
    private static int soupCounterY = 20;
    private static int fpsCounterX = 5;
    private static int fpsCounterY = 35;
    private static int pingCounterX = 5;
    private static int pingCounterY = 50;
    private static int clockX = 5;
    private static int clockY = 65;
    private static int cpsCounterX = 5;
    private static int cpsCounterY = 80;
    ...
    public static int getSoupCounterX() {
        return soupCounterX;
    }
    
    public static int getSoupCounterY() {
        return soupCounterY;
    }
    
    public static void setSoupCounterX(int x) {
        soupCounterX = x;
        save();
    }
    
    public static void setSoupCounterY(int y) {
        soupCounterY = y;
        save();
    }
    
    public static int getFPSCounterX() {
        return fpsCounterX;
    }
    
    public static int getFPSCounterY() {
        return fpsCounterY;
    }
    
    public static void setFPSCounterX(int x) {
        fpsCounterX = x;
        save();
    }
    
    public static void setFPSCounterY(int y) {
        fpsCounterY = y;
        save();
    }
    
    public static int getPingCounterX() {
        return pingCounterX;
    }
    
    public static int getPingCounterY() {
        return pingCounterY;
    }
    
    public static void setPingCounterX(int x) {
        pingCounterX = x;
        save();
    }
    
    public static void setPingCounterY(int y) {
        pingCounterY = y;
        save();
    }
    
    public static int getClockX() {
        return clockX;
    }
    
    public static int getClockY() {
        return clockY;
    }
    
    public static void setClockX(int x) {
        clockX = x;
        save();
    }
    
    public static void setClockY(int y) {
        clockY = y;
        save();
    }
    
    public static int getCPSCounterX() {
        return cpsCounterX;
    }
    
    public static int getCPSCounterY() {
        return cpsCounterY;
    }
    
    public static void setCPSCounterX(int x) {
        cpsCounterX = x;
        save();
    }
    
    public static void setCPSCounterY(int y) {
        cpsCounterY = y;
        save();
    }
    
    // Scale getters and setters
    public static float getSoupCounterScale() {
        return soupCounterScale;
    }
    
    public static void setSoupCounterScale(float scale) {
        soupCounterScale = Math.max(0.5f, Math.min(3.0f, scale));
        save();
    }
    
    public static float getCPSCounterScale() {
        return cpsCounterScale;
    }
    
    public static void setCPSCounterScale(float scale) {
        cpsCounterScale = Math.max(0.5f, Math.min(3.0f, scale));
        save();
    }
    
    public static float getFPSCounterScale() {
        return fpsCounterScale;
    }
    
    public static void setFPSCounterScale(float scale) {
        fpsCounterScale = Math.max(0.5f, Math.min(3.0f, scale));
        save();
    }
    
    public static float getPingCounterScale() {
        return pingCounterScale;
    }
    
    public static void setPingCounterScale(float scale) {
        pingCounterScale = Math.max(0.5f, Math.min(3.0f, scale));
        save();
    }
    
    public static float getClockScale() {
        return clockScale;
    }
    
    public static void setClockScale(float scale) {
        clockScale = Math.max(0.5f, Math.min(3.0f, scale));
        save();
    }
